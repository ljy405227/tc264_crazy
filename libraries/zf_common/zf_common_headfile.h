...
extern uint8_t transistor_Num;
extern uint8_t Gyr_dir;
extern uint8_t ban_transisitor;
extern uint8_t Direction_Planning;
...
extern volatile int speed_target;
extern volatile int speed_target_max;
extern volatile int speed_dis_original;
extern volatile int speed_dis_feedback;
extern int speed_final_average;
...
extern volatile uint8_t pit_control_flag;
extern volatile uint8_t first_flag;
extern int16 encoder_data_1;
extern int16 encoder_data_2;
extern uint16_t turn_time_count;
extern uint8_t Img_Gap_left;
extern uint8_t Img_Gap_right;


// extern float yaw_diff;
