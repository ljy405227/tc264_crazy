...
//-------------------------------------------------------------------------------------------------------------------
uint8 new_flash_check(uint32 sector_num, uint32 page_num)
{
...
//-------------------------------------------------------------------------------------------------------------------
void new_eeprom_erase_sector(uint32 sector_num)
{
    zf_assert(EEPROM_SECTOR_NUM>sector_num);
...
//-------------------------------------------------------------------------------------------------------------------
void new_eeprom_page_program(uint32 sector_num, uint32 page_num, uint32 *buf)
{
    zf_assert(EEPROM_SECTOR_NUM>sector_num);
    zf_assert(EEPROM_SECTOR_PAGE_NUM>page_num);
