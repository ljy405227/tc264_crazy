...
#define IPS200_SCL_PIN_SPI              (SPI0_SCLK_P20_13 )                      // 硬件 SPI SCK 引脚
#define IPS200_SDA_PIN_SPI              (SPI0_MOSI_P20_14 )                      // 硬件 SPI MOSI 引脚
#define IPS200_SDA_IN_PIN_SPI           (SPI0_MISO_P20_12 )                      // 硬件 SPI MISO 引脚  IPS没有MISO引脚，但是这里任然需要定义，在spi的初始化时需要使用
//====================================================硬件 SPI 驱动====================================================
#endif
// 如果使用的是SPI 串口的两寸屏幕 SPI 驱动控制引脚 可以修改
#define IPS200_RST_PIN_SPI              (P20_11)                                 // (SPI串口)液晶复位引脚定义
#define IPS200_DC_PIN_SPI               (P20_10)                                 // (SPI串口)液晶命令位引脚定义
#define IPS200_CS_PIN_SPI               (P20_9)                                  // (SPI串口)液晶片选引脚定义
#define IPS200_BLk_PIN_SPI              (P20_12)                                  // (SPI串口)液晶背光引脚定义
