...
#define IMU660RB_SPC_PIN                            (SPI1_SCLK_P10_2)          // 硬件 SPI SCK 引脚
#define IMU660RB_SDI_PIN                            (SPI1_MOSI_P10_3)          // 硬件 SPI MOSI 引脚
#define IMU660RB_SDO_PIN                            (SPI1_MISO_P10_1)          // 硬件 SPI MISO 引脚
//====================================================硬件 SPI 驱动====================================================
#endif

#define IMU660RB_CS_PIN                             (P11_11)                    // CS 片选引脚
